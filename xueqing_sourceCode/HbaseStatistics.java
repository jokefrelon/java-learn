...
public void countEducationDistribution(String tableName, String mongoTable, String family) throws SQLException, IOException {/////
		...
		for (Result res : scanner1) {
			...
			String edu = new String(CellUtil.cloneValue(res.rawCells()[1]));
			int total = Integer.parseInt(new String(CellUtil.cloneValue(res.rawCells()[0])));
			int num = 1;
			if (edu.contains(".")) {
			} else {
				...
				logger.info(edu + ":" + total);
			}
		}
		Document doc1 = new Document();
		mongodbstorage.appendExperience(doc1, "初中", cu[0], nu[0]);
		vec.add(doc1);
		Document doc2 = new Document();
		mongodbstorage.appendExperience(doc2, "高中", cu[1], nu[1]);
		vec.add(doc2);
		Document doc3 = new Document();
		mongodbstorage.appendExperience(doc3, "中技", cu[2], nu[2]);
		vec.add(doc3);
		Document doc4 = new Document();
		mongodbstorage.appendExperience(doc4, "中专", cu[3], nu[3]);
		vec.add(doc4);
		Document doc5 = new Document();
		mongodbstorage.appendExperience(doc5, "大专", cu[4], nu[4]);
		vec.add(doc5);
		Document doc6 = new Document();
		mongodbstorage.appendExperience(doc6, "本科", cu[5], nu[5]);
		vec.add(doc6);
		Document doc7 = new Document();
		mongodbstorage.appendExperience(doc7, "硕士", cu[6], nu[6]);
		vec.add(doc7);
		Document doc8 = new Document();
		mongodbstorage.appendExperience(doc8, "博士", cu[7], nu[7]);
		vec.add(doc8);
		Document doc9 = new Document();
		mongodbstorage.appendExperience(doc9, "不限", cu[8], nu[8]);
		vec.add(doc9);
