...
public class filePath {
	public static void main(String[] args) throws IOException {
		...
		System.out.println(str + "~~~~~" + str1);//绝对路径和相对路径的区别

		Long lon = file.lastModified();
		Date date = new Date(lon);
		String mod_time = DateFormat.getDateTimeInstance(DateFormat.LONG, DateFormat.LONG).format(date); //获取修改时间并转化为<Long> {}的方式显示
